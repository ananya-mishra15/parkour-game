...
Game.LEVELS = [
  ...
  // ===================================================================
  // ASTRAL VOID FINALE (levels 88 – 90)
  // ===================================================================
  {
    name: '88 · Void Rift',
    width: 3800, height: 540,
    ...
    tiles: [
      { x: 0,    y: 480, w: 260, h: 60,  type: 'ground' },
      { x: 900,  y: 480, w: 120, h: 60,  type: 'ground' },
      { x: 1020, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 2000, y: 480, w: 240, h: 60,  type: 'ground' },
      { x: 2320, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 2520, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 2360, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 2560, y: 160, w: 200, h: 18,  type: 'ground' },
      { x: 2900, y: 260, w: 200, h: 18,  type: 'ice' },
      { x: 3160, y: 220, w: 120, h: 14,  type: 'oneway' },
      { x: 3340, y: 180, w: 120, h: 14,  type: 'oneway' },
      { x: 3500, y: 140, w: 120, h: 14,  type: 'oneway' },
      { x: 3640, y: 100, w: 160, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 260,  y: 530, w: 640, h: 10, type: 'spikes' },
      { x: 1100, y: 530, w: 900, h: 10, type: 'spikes' },
      { x: 2360, y: 530, w: 160, h: 10, type: 'spikes' },
      { x: 2760, y: 530, w: 1040, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 360,  y: 420, w: 100, h: 18, fall: true, delay: 0.35 },
      { x: 540,  y: 380, w: 100, h: 18, fall: true, delay: 0.35 },
      { x: 720,  y: 420, w: 100, h: 18, fall: true, delay: 0.35 },
      { x: 2760, y: 300, w: 100, h: 18, move: { axis: 'xy', range: 100, speed: 60 } },
    ],
    ropes: [
      { x: 1200, y: 50, length: 260 },
      { x: 1500, y: 50, length: 280 },
      { x: 1800, y: 50, length: 260 },
    ],
    checkpoints: [
      { x: 940,  y: 420, w: 40, h: 60 },
      { x: 2600, y: 100, w: 40, h: 60 },
    ],
    coins: [
      { x: 160, y: 420 },
      { x: 400, y: 360 }, { x: 580, y: 320 }, { x: 760, y: 360 },
      { x: 960, y: 420 },
      { x: 1200, y: 240 }, { x: 1350, y: 200 }, { x: 1500, y: 220 },
      { x: 1650, y: 200 }, { x: 1800, y: 240 },
      { x: 2060, y: 420 },
      { x: 2400, y: 380 }, { x: 2420, y: 260 }, { x: 2440, y: 140 },
      { x: 2620, y: 120 },
      { x: 2820, y: 260 }, { x: 2960, y: 220 },
      { x: 3220, y: 180 }, { x: 3400, y: 140 },
      { x: 3720, y: 60 },
    ],
  },
  {
    name: '89 · Entropy Cascade',
    width: 4000, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3900, y: 80 },
    sky: '#000108',
    tiles: [
      { x: 0,    y: 480, w: 260, h: 60,  type: 'ground' },
      { x: 680,  y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 1280, y: 200, w: 240, h: 18,  type: 'ground' },
      { x: 1280, y: 220, w: 40,  h: 280, type: 'wall' },
      { x: 1700, y: 480, w: 200, h: 60,  type: 'ice' },
      { x: 1900, y: 200, w: 40,  h: 340, type: 'wall' },
      { x: 1940, y: 200, w: 160, h: 18,  type: 'branch' },
      { x: 2600, y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 3200, y: 300, w: 140, h: 14,  type: 'oneway' },
      { x: 3400, y: 260, w: 140, h: 14,  type: 'oneway' },
      { x: 3600, y: 220, w: 140, h: 14,  type: 'oneway' },
      { x: 3800, y: 120, w: 200, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 260,  y: 530, w: 420, h: 10, type: 'spikes' },
      { x: 880,  y: 530, w: 400, h: 10, type: 'spikes' },
      { x: 1520, y: 530, w: 180, h: 10, type: 'spikes' },
      { x: 2100, y: 530, w: 500, h: 10, type: 'spikes' },
      { x: 2800, y: 530, w: 1200, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 2900, y: 360, w: 100, h: 18, move: { axis: 'y', range: 100, speed: 60 } },
      { x: 3060, y: 320, w: 80,  h: 18, move: { axis: 'x', range: 80,  speed: 55 } },
    ],
    cannons: [
      { x: 160,  y: 400, w: 70, h: 70, angle: -22, power: 900 },
      { x: 760,  y: 400, w: 70, h: 70, angle: -28, power: 920 },
      { x: 2660, y: 400, w: 70, h: 70, angle: -40, power: 940 },
    ],
    ziplines: [
      { x1: 1060, y1: 140, x2: 1280, y2: 180 },
      { x1: 2200, y1: 120, x2: 2600, y2: 460 },
    ],
    climbs: [
      { x: 1280, y: 220, w: 40, h: 260 },
      { x: 1900, y: 200, w: 40, h: 280 },
    ],
    ropes: [
      { x: 2100, y: 60, length: 220 },
    ],
    checkpoints: [
      { x: 1340, y: 160, w: 40, h: 60 },
      { x: 1760, y: 420, w: 40, h: 60 },
      { x: 2660, y: 420, w: 40, h: 60 },
    ],
    coins: [
      { x: 160, y: 420 },
      { x: 420, y: 280 }, { x: 520, y: 260 },
      { x: 780, y: 420 },
      { x: 1100, y: 120 }, { x: 1180, y: 140 },
      { x: 1320, y: 380 }, { x: 1320, y: 260 }, { x: 1340, y: 160 },
      { x: 1760, y: 420 }, { x: 1860, y: 420 },
      { x: 1940, y: 360 }, { x: 1960, y: 240 }, { x: 1980, y: 160 },
      { x: 2160, y: 200 }, { x: 2400, y: 300 },
      { x: 2720, y: 420 },
      { x: 2960, y: 320 }, { x: 3120, y: 280 },
      { x: 3260, y: 260 }, { x: 3460, y: 220 },
      { x: 3860, y: 80 },
    ],
  },
  {
    name: '90 · The Last Breath',
    width: 4400, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 4300, y: 60 },
    sky: '#000000',
    tiles: [
      { x: 0,    y: 480, w: 240, h: 60,  type: 'ground' },
      { x: 700,  y: 440, w: 100, h: 18,  type: 'bouncy' },
      { x: 880,  y: 300, w: 160, h: 18,  type: 'branch' },
      { x: 1200, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 1400, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 1240, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 1440, y: 140, w: 200, h: 18,  type: 'ground' },
      { x: 1800, y: 280, w: 200, h: 18,  type: 'ice' },
      { x: 2360, y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 2900, y: 400, w: 160, h: 140, type: 'ground' },
      { x: 3260, y: 340, w: 120, h: 200, type: 'ground' },
      { x: 3500, y: 280, w: 100, h: 18,  type: 'bouncy' },
      { x: 3700, y: 200, w: 120, h: 14,  type: 'oneway' },
      { x: 3860, y: 160, w: 120, h: 14,  type: 'oneway' },
      { x: 4020, y: 120, w: 120, h: 14,  type: 'oneway' },
      { x: 4180, y: 100, w: 220, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 240,  y: 530, w: 460, h: 10, type: 'spikes' },
      { x: 800,  y: 530, w: 400, h: 10, type: 'spikes' },
      { x: 1240, y: 530, w: 160, h: 10, type: 'spikes' },
      { x: 1640, y: 530, w: 720, h: 10, type: 'spikes' },
      { x: 2520, y: 530, w: 380, h: 10, type: 'spikes' },
      { x: 3060, y: 530, w: 200, h: 10, type: 'spikes' },
      { x: 3380, y: 530, w: 1020, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 2560, y: 420, w: 100, h: 18, fall: true, delay: 0.3 },
      { x: 2660, y: 380, w: 100, h: 18, fall: true, delay: 0.3 },
      { x: 2760, y: 420, w: 100, h: 18, fall: true, delay: 0.3 },
      { x: 2860, y: 380, w: 80,  h: 18, fall: true, delay: 0.3 },
      { x: 3100, y: 360, w: 100, h: 18, move: { axis: 'xy', range: 120, speed: 65 } },
    ],
    cannons: [
      { x: 140, y: 400, w: 70, h: 70, angle: -20, power: 900 },
    ],
    ropes: [
      { x: 1660, y: 50, length: 220 },
    ],
    ziplines: [
      { x1: 2000, y1: 200, x2: 2360, y2: 460 },
    ],
    climbs: [
      { x: 1200, y: 80, w: 40, h: 200 },
    ],
    checkpoints: [
      { x: 1500, y: 80, w: 40, h: 60 },
      { x: 2400, y: 420, w: 40, h: 60 },
      { x: 3300, y: 280, w: 40, h: 60 },
    ],
    coins: [
      { x: 160, y: 420 },
      { x: 460, y: 300 }, { x: 560, y: 280 },
      { x: 740, y: 380 }, { x: 920, y: 260 }, { x: 980, y: 260 },
      { x: 1280, y: 360 }, { x: 1300, y: 240 }, { x: 1320, y: 120 },
      { x: 1500, y: 100 },
      { x: 1700, y: 200 }, { x: 1860, y: 240 },
      { x: 2100, y: 280 }, { x: 2300, y: 400 },
      { x: 2600, y: 360 }, { x: 2700, y: 320 }, { x: 2800, y: 360 },
      { x: 2960, y: 340 },
      { x: 3140, y: 320 }, { x: 3320, y: 300 },
      { x: 3540, y: 220 }, { x: 3760, y: 160 },
      { x: 3920, y: 120 }, { x: 4240, y: 60 },
      { x: 4340, y: 60 },
    ],
  },
  // ===================================================================
  // BONUS CHALLENGE LEVELS (B1–B10, levels 91 – 100)
  // ===================================================================
  {
    name: '91 · B1 · Pendulum Nightmare',
    width: 3800, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3700, y: 380 },
    sky: '#1a0030',
    tiles: [
      { x: 0,    y: 480, w: 140, h: 60, type: 'ground' },
      { x: 140,  y: 480, w: 80,  h: 60, type: 'bouncy' },
      { x: 1780, y: 360, w: 80,  h: 18, type: 'branch' },
      { x: 3600, y: 480, w: 200, h: 60, type: 'ground' },
    ],
    hazards: [
      { x: 220,  y: 530, w: 1560, h: 10, type: 'spikes' },
      { x: 1860, y: 530, w: 1740, h: 10, type: 'spikes' },
    ],
    platforms: [],
    ropes: [
      { x: 380,  y: 40, length: 280 },
      { x: 640,  y: 60, length: 300 },
      { x: 900,  y: 40, length: 260 },
      { x: 1160, y: 60, length: 280 },
      { x: 1420, y: 40, length: 300 },
      { x: 1680, y: 60, length: 260 },
      { x: 1960, y: 40, length: 280 },
      { x: 2220, y: 60, length: 300 },
      { x: 2480, y: 40, length: 260 },
      { x: 2740, y: 60, length: 280 },
      { x: 3000, y: 40, length: 300 },
      { x: 3280, y: 60, length: 260, startAngle: 0.3 },
    ],
    checkpoints: [
      { x: 1780, y: 300, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 380, y: 200 }, { x: 640, y: 220 }, { x: 900, y: 200 },
      { x: 1160, y: 220 }, { x: 1420, y: 200 }, { x: 1680, y: 220 },
      { x: 1960, y: 200 }, { x: 2220, y: 220 }, { x: 2480, y: 200 },
      { x: 2740, y: 220 }, { x: 3000, y: 200 }, { x: 3280, y: 220 },
      { x: 3660, y: 420 }, { x: 3740, y: 420 },
    ],
  },
  {
    name: '92 · B2 · Cannon Gauntlet',
    width: 3400, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3300, y: 380 },
    sky: '#300010',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60, type: 'ground' },
      { x: 460,  y: 480, w: 180, h: 60, type: 'ground' },
      { x: 880,  y: 480, w: 180, h: 60, type: 'ground' },
      { x: 1280, y: 480, w: 180, h: 60, type: 'ground' },
      { x: 1680, y: 480, w: 180, h: 60, type: 'ground' },
      { x: 2060, y: 480, w: 180, h: 60, type: 'ground' },
      { x: 2440, y: 480, w: 180, h: 60, type: 'ground' },
      { x: 2800, y: 480, w: 180, h: 60, type: 'ground' },
      { x: 3200, y: 480, w: 200, h: 60, type: 'ground' },
    ],
    hazards: [
      { x: 200,  y: 530, w: 260, h: 10, type: 'spikes' },
      { x: 640,  y: 530, w: 240, h: 10, type: 'spikes' },
      { x: 1060, y: 530, w: 220, h: 10, type: 'spikes' },
      { x: 1460, y: 530, w: 220, h: 10, type: 'spikes' },
      { x: 1860, y: 530, w: 200, h: 10, type: 'spikes' },
      { x: 2240, y: 530, w: 200, h: 10, type: 'spikes' },
      { x: 2620, y: 530, w: 180, h: 10, type: 'spikes' },
      { x: 2980, y: 530, w: 220, h: 10, type: 'spikes' },
    ],
    platforms: [],
    cannons: [
      { x: 60,   y: 400, w: 70, h: 70, angle: -22, power: 880 },
      { x: 520,  y: 400, w: 70, h: 70, angle: -25, power: 900 },
      { x: 940,  y: 400, w: 70, h: 70, angle: -22, power: 880 },
      { x: 1340, y: 400, w: 70, h: 70, angle: -25, power: 900 },
      { x: 1740, y: 400, w: 70, h: 70, angle: -22, power: 880 },
      { x: 2120, y: 400, w: 70, h: 70, angle: -25, power: 900 },
      { x: 2500, y: 400, w: 70, h: 70, angle: -22, power: 880 },
      { x: 2860, y: 400, w: 70, h: 70, angle: -20, power: 860 },
    ],
    checkpoints: [
      { x: 1740, y: 420, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 300, y: 240 }, { x: 380, y: 220 },
      { x: 720, y: 240 }, { x: 800, y: 220 },
      { x: 1120, y: 240 }, { x: 1200, y: 220 },
      { x: 1520, y: 240 }, { x: 1600, y: 220 },
      { x: 1900, y: 240 }, { x: 1980, y: 220 },
      { x: 2280, y: 240 }, { x: 2360, y: 220 },
      { x: 2660, y: 240 }, { x: 2740, y: 220 },
      { x: 3040, y: 260 }, { x: 3120, y: 240 },
      { x: 3280, y: 420 },
    ],
  },
  {
    name: '93 · B3 · Frostbite',
    width: 3400, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3300, y: 320 },
    sky: '#001030',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60, type: 'ground' },
      { x: 200,  y: 480, w: 400, h: 60, type: 'ice' },
      { x: 700,  y: 480, w: 300, h: 60, type: 'ice' },
      { x: 700,  y: 420, w: 300, h: 60, type: 'ground' },
      { x: 1100, y: 480, w: 400, h: 60, type: 'ice' },
      { x: 1600, y: 440, w: 60,  h: 100, type: 'ground' },
      { x: 1660, y: 440, w: 300, h: 18, type: 'ice' },
      { x: 1960, y: 440, w: 60,  h: 100, type: 'ground' },
      { x: 2120, y: 80,  w: 40,  h: 460, type: 'wall' },
      { x: 2300, y: 80,  w: 40,  h: 460, type: 'wall' },
      { x: 2160, y: 80,  w: 140, h: 18, type: 'branch' },
      { x: 2340, y: 140, w: 200, h: 18, type: 'ground' },
      { x: 2640, y: 480, w: 300, h: 60, type: 'ice' },
      { x: 2940, y: 480, w: 60,  h: 60, type: 'ground' },
      { x: 3000, y: 380, w: 200, h: 160, type: 'ground' },
      { x: 3200, y: 360, w: 200, h: 180, type: 'ground' },
    ],
    hazards: [
      { x: 600,  y: 530, w: 100, h: 10, type: 'spikes' },
      { x: 1000, y: 530, w: 100, h: 10, type: 'spikes' },
      { x: 1500, y: 530, w: 100, h: 10, type: 'spikes' },
      { x: 2020, y: 530, w: 100, h: 10, type: 'spikes' },
      { x: 2160, y: 530, w: 140, h: 10, type: 'spikes' },
      { x: 2540, y: 530, w: 100, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 2480, y: 300, w: 100, h: 18, type: 'ice', move: { axis: 'x', range: 80, speed: 50 } },
    ],
    checkpoints: [
      { x: 1640, y: 380, w: 40, h: 60 },
      { x: 2400, y: 80,  w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 300, y: 420 }, { x: 440, y: 420 }, { x: 540, y: 420 },
      { x: 800, y: 420 }, { x: 900, y: 420 },
      { x: 1200, y: 420 }, { x: 1360, y: 420 },
      { x: 1700, y: 380 }, { x: 1800, y: 380 }, { x: 1900, y: 380 },
      { x: 2200, y: 360 }, { x: 2220, y: 240 }, { x: 2240, y: 120 },
      { x: 2420, y: 100 },
      { x: 2540, y: 260 }, { x: 2700, y: 420 }, { x: 2840, y: 420 },
      { x: 3060, y: 320 }, { x: 3300, y: 320 },
    ],
  },
  {
    name: '94 · B4 · Crumbling Void',
    width: 3800, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3700, y: 380 },
    sky: '#200020',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60, type: 'ground' },
      { x: 1820, y: 480, w: 140, h: 60, type: 'ground' },
      { x: 3600, y: 480, w: 200, h: 60, type: 'ground' },
    ],
    hazards: [
      { x: 200,  y: 530, w: 1620, h: 10, type: 'spikes' },
      { x: 1960, y: 530, w: 1640, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 280,  y: 440, w: 100, h: 18, fall: true, delay: 0.5 },
      { x: 440,  y: 400, w: 100, h: 18, fall: true, delay: 0.5 },
      { x: 600,  y: 440, w: 100, h: 18, fall: true, delay: 0.5 },
      { x: 760,  y: 400, w: 100, h: 18, fall: true, delay: 0.5 },
      { x: 920,  y: 360, w: 100, h: 18, fall: true, delay: 0.5 },
      { x: 1080, y: 400, w: 100, h: 18, fall: true, delay: 0.4 },
      { x: 1240, y: 440, w: 100, h: 18, fall: true, delay: 0.4 },
      { x: 1400, y: 400, w: 100, h: 18, fall: true, delay: 0.4 },
      { x: 1560, y: 360, w: 100, h: 18, fall: true, delay: 0.4 },
      { x: 1700, y: 400, w: 100, h: 18, fall: true, delay: 0.4 },
      { x: 2020, y: 440, w: 90,  h: 18, fall: true, delay: 0.35 },
      { x: 2170, y: 400, w: 90,  h: 18, fall: true, delay: 0.35 },
      { x: 2320, y: 360, w: 90,  h: 18, fall: true, delay: 0.35 },
      { x: 2470, y: 400, w: 90,  h: 18, fall: true, delay: 0.35 },
      { x: 2620, y: 440, w: 90,  h: 18, fall: true, delay: 0.35 },
      { x: 2770, y: 400, w: 80,  h: 18, fall: true, delay: 0.25 },
      { x: 2920, y: 360, w: 80,  h: 18, fall: true, delay: 0.25 },
      { x: 3060, y: 400, w: 80,  h: 18, fall: true, delay: 0.25 },
      { x: 3200, y: 440, w: 80,  h: 18, fall: true, delay: 0.25 },
      { x: 3360, y: 400, w: 80,  h: 18, fall: true, delay: 0.25 },
    ],
    checkpoints: [
      { x: 1860, y: 420, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 320, y: 380 }, { x: 640, y: 380 }, { x: 960, y: 300 },
      { x: 1280, y: 380 }, { x: 1600, y: 300 },
      { x: 1880, y: 420 },
      { x: 2060, y: 380 }, { x: 2360, y: 300 }, { x: 2660, y: 380 },
      { x: 2810, y: 340 }, { x: 2960, y: 300 }, { x: 3100, y: 340 },
      { x: 3240, y: 380 }, { x: 3400, y: 340 },
      { x: 3680, y: 420 },
    ],
  },
  {
    name: '95 · B5 · Vertical Shaft',
    ...
    tiles: [
      { x: 0,   y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 200, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 400, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 240, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 440, y: 100, w: 160, h: 18,  type: 'ground' },
      { x: 600, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 800, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 640, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 840, y: 100, w: 160, h: 18,  type: 'ground' },
      { x: 1000, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 1200, y: 80,  w: 40,  h: 440, type: 'wall' },
      { x: 1040, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 300, y: 300, w: 60,  h: 18,  type: 'bouncy' },
      { x: 700, y: 340, w: 60,  h: 18,  type: 'bouncy' },
      { x: 1100, y: 300, w: 60,  h: 18, type: 'bouncy' },
    ],
    hazards: [
      { x: 240,  y: 530, w: 160, h: 10, type: 'spikes' },
      { x: 640,  y: 530, w: 160, h: 10, type: 'spikes' },
      { x: 1040, y: 530, w: 160, h: 10, type: 'spikes' },
    ],
    platforms: [],
    checkpoints: [
      { x: 500, y: 60, w: 40, h: 60 },
      { x: 900, y: 60, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 310, y: 420 }, { x: 320, y: 320 }, { x: 330, y: 220 },
      { x: 340, y: 140 }, { x: 480, y: 60 },
      { x: 710, y: 420 }, { x: 720, y: 320 }, { x: 730, y: 220 },
      { x: 740, y: 140 }, { x: 880, y: 60 },
      { x: 1110, y: 420 }, { x: 1120, y: 320 }, { x: 1130, y: 220 },
      { x: 1140, y: 140 }, { x: 1100, y: 60 },
      { x: 500, y: 60 }, { x: 900, y: 60 },
    ],
  },
  {
    name: '96 · B6 · Zipline Express',
    width: 4000, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3900, y: 380 },
    sky: '#002030',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 200,  y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 640,  y: 200, w: 80,  h: 18,  type: 'branch' },
      { x: 1080, y: 400, w: 80,  h: 18,  type: 'branch' },
      { x: 1480, y: 180, w: 80,  h: 18,  type: 'branch' },
      { x: 1920, y: 380, w: 140, h: 18,  type: 'branch' },
      { x: 2360, y: 160, w: 80,  h: 18,  type: 'branch' },
      { x: 2800, y: 380, w: 80,  h: 18,  type: 'branch' },
      { x: 3200, y: 200, w: 80,  h: 18,  type: 'branch' },
      { x: 3600, y: 400, w: 80,  h: 18,  type: 'branch' },
      { x: 3800, y: 480, w: 200, h: 60,  type: 'ground' },
    ],
    hazards: [
      { x: 280,  y: 530, w: 3520, h: 10, type: 'spikes' },
    ],
    platforms: [],
    ziplines: [
      { x1: 280,  y1: 400, x2: 640,  y2: 180 },
      { x1: 720,  y1: 200, x2: 1080, y2: 380 },
      { x1: 1160, y1: 380, x2: 1480, y2: 160 },
      { x1: 1560, y1: 180, x2: 1920, y2: 360 },
      { x1: 2060, y1: 360, x2: 2360, y2: 140 },
      { x1: 2440, y1: 160, x2: 2800, y2: 360 },
      { x1: 2880, y1: 360, x2: 3200, y2: 180 },
      { x1: 3280, y1: 200, x2: 3600, y2: 380 },
    ],
    checkpoints: [
      { x: 1960, y: 320, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 400, y: 300 }, { x: 520, y: 220 },
      { x: 840, y: 260 }, { x: 960, y: 340 },
      { x: 1260, y: 300 }, { x: 1380, y: 200 },
      { x: 1680, y: 240 }, { x: 1800, y: 320 },
      { x: 2160, y: 280 }, { x: 2280, y: 180 },
      { x: 2560, y: 240 }, { x: 2700, y: 320 },
      { x: 2980, y: 300 }, { x: 3100, y: 220 },
      { x: 3880, y: 420 },
    ],
  },
  {
    name: '97 · B7 · Climb the Impossible',
    width: 2800, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 2700, y: 60 },
    sky: '#001020',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 300,  y: 200, w: 40,  h: 340, type: 'wall' },
      { x: 340,  y: 200, w: 60,  h: 18,  type: 'branch' },
      { x: 700,  y: 240, w: 40,  h: 300, type: 'wall' },
      { x: 740,  y: 240, w: 60,  h: 18,  type: 'branch' },
      { x: 1100, y: 180, w: 40,  h: 360, type: 'wall' },
      { x: 1140, y: 180, w: 60,  h: 18,  type: 'branch' },
      { x: 1500, y: 220, w: 40,  h: 320, type: 'wall' },
      { x: 1540, y: 220, w: 60,  h: 18,  type: 'branch' },
      { x: 1900, y: 160, w: 40,  h: 380, type: 'wall' },
      { x: 1940, y: 160, w: 60,  h: 18,  type: 'branch' },
      { x: 2300, y: 100, w: 40,  h: 440, type: 'wall' },
      { x: 2500, y: 100, w: 40,  h: 440, type: 'wall' },
      { x: 2340, y: 100, w: 160, h: 18,  type: 'branch' },
      { x: 2540, y: 100, w: 260, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 200,  y: 530, w: 2600, h: 10, type: 'spikes' },
    ],
    platforms: [],
    climbs: [
      { x: 300,  y: 200, w: 40, h: 280 },
      { x: 700,  y: 240, w: 40, h: 260 },
      { x: 1100, y: 180, w: 40, h: 300 },
      { x: 1500, y: 220, w: 40, h: 280 },
      { x: 1900, y: 160, w: 40, h: 320 },
    ],
    ropes: [
      { x: 500,  y: 60, length: 240 },
      { x: 900,  y: 60, length: 260 },
      { x: 1300, y: 60, length: 220 },
      { x: 1700, y: 60, length: 240 },
      { x: 2100, y: 60, length: 220 },
    ],
    checkpoints: [
      { x: 1140, y: 120, w: 40, h: 60 },
      { x: 1940, y: 100, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 320, y: 400 }, { x: 330, y: 300 }, { x: 500, y: 200 },
      { x: 720, y: 380 }, { x: 730, y: 300 }, { x: 900, y: 200 },
      { x: 1120, y: 360 }, { x: 1130, y: 260 }, { x: 1300, y: 180 },
      { x: 1520, y: 360 }, { x: 1530, y: 280 }, { x: 1700, y: 200 },
      { x: 1920, y: 340 }, { x: 1930, y: 240 },
      { x: 2400, y: 340 }, { x: 2420, y: 220 }, { x: 2440, y: 120 },
      { x: 2700, y: 60 },
    ],
  },
  {
    name: '98 · B8 · Neon Bounce',
    width: 3000, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 2900, y: 120 },
    sky: '#200030',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 260,  y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 480,  y: 200, w: 100, h: 18,  type: 'branch' },
      { x: 680,  y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 920,  y: 180, w: 100, h: 18,  type: 'branch' },
      { x: 1100, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 1320, y: 160, w: 100, h: 18,  type: 'branch' },
      { x: 1480, y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 1760, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 1960, y: 200, w: 100, h: 18,  type: 'branch' },
      { x: 2160, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 2380, y: 180, w: 100, h: 18,  type: 'branch' },
      { x: 2560, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 2780, y: 160, w: 220, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 340,  y: 530, w: 340, h: 10, type: 'spikes' },
      { x: 760,  y: 530, w: 340, h: 10, type: 'spikes' },
      { x: 1180, y: 530, w: 300, h: 10, type: 'spikes' },
      { x: 1680, y: 530, w: 80,  h: 10, type: 'spikes' },
      { x: 1840, y: 530, w: 320, h: 10, type: 'spikes' },
      { x: 2240, y: 530, w: 320, h: 10, type: 'spikes' },
      { x: 2640, y: 530, w: 340, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 2060, y: 480, w: 80, h: 18, move: { axis: 'x', range: 60, speed: 50 } },
    ],
    checkpoints: [
      { x: 1540, y: 420, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 320, y: 240 }, { x: 380, y: 200 }, { x: 520, y: 160 },
      { x: 740, y: 240 }, { x: 800, y: 200 }, { x: 960, y: 140 },
      { x: 1160, y: 240 }, { x: 1220, y: 200 }, { x: 1360, y: 120 },
      { x: 1560, y: 420 },
      { x: 1820, y: 240 }, { x: 1880, y: 200 }, { x: 2000, y: 160 },
      { x: 2220, y: 240 }, { x: 2280, y: 200 }, { x: 2420, y: 140 },
      { x: 2620, y: 240 }, { x: 2680, y: 200 },
      { x: 2860, y: 120 },
    ],
  },
  {
    name: '99 · B9 · Chaos Machine',
    width: 3600, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 3500, y: 340 },
    sky: '#180008',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 1200, y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 1200, y: 200, w: 40,  h: 280, type: 'wall' },
      { x: 2400, y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 2400, y: 240, w: 40,  h: 240, type: 'wall' },
      { x: 3400, y: 380, w: 200, h: 160, type: 'ground' },
    ],
    hazards: [
      { x: 200,  y: 530, w: 1000, h: 10, type: 'spikes' },
      { x: 1360, y: 530, w: 1040, h: 10, type: 'spikes' },
      { x: 2560, y: 530, w: 840,  h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 280,  y: 420, w: 100, h: 18, move: { axis: 'x',  range: 140, speed: 70 } },
      { x: 480,  y: 360, w: 80,  h: 18, move: { axis: 'y',  range: 120, speed: 65 } },
      { x: 680,  y: 400, w: 100, h: 18, move: { axis: 'xy', range: 100, speed: 68 } },
      { x: 900,  y: 340, w: 80,  h: 18, move: { axis: 'x',  range: 160, speed: 75 } },
      { x: 1420, y: 420, w: 100, h: 18, move: { axis: 'y',  range: 140, speed: 70 } },
      { x: 1640, y: 360, w: 80,  h: 18, move: { axis: 'xy', range: 120, speed: 68 } },
      { x: 1860, y: 400, w: 100, h: 18, move: { axis: 'x',  range: 100, speed: 72 } },
      { x: 2080, y: 340, w: 80,  h: 18, move: { axis: 'y',  range: 120, speed: 65 } },
      { x: 2620, y: 400, w: 100, h: 18, move: { axis: 'xy', range: 140, speed: 70 } },
      { x: 2860, y: 360, w: 80,  h: 18, move: { axis: 'x',  range: 120, speed: 75 } },
      { x: 3060, y: 420, w: 100, h: 18, fall: true, delay: 0.3 },
      { x: 3220, y: 380, w: 100, h: 18, move: { axis: 'y',  range: 80,  speed: 60 } },
    ],
    checkpoints: [
      { x: 1260, y: 420, w: 40, h: 60 },
      { x: 2460, y: 420, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 340, y: 360 }, { x: 540, y: 300 }, { x: 740, y: 340 },
      { x: 960, y: 280 }, { x: 1080, y: 320 },
      { x: 1280, y: 420 },
      { x: 1480, y: 360 }, { x: 1700, y: 300 }, { x: 1920, y: 340 },
      { x: 2140, y: 280 }, { x: 2280, y: 320 },
      { x: 2460, y: 420 },
      { x: 2680, y: 340 }, { x: 2920, y: 300 }, { x: 3100, y: 360 },
      { x: 3280, y: 320 },
      { x: 3460, y: 340 }, { x: 3540, y: 340 },
      { x: 1260, y: 160 }, { x: 2460, y: 200 },
      { x: 780, y: 200 },
    ],
  },
  {
    name: '100 · B10 · Singularity Prime',
    width: 4400, height: 540,
    spawn: { x: 60, y: 380 },
    goal:  { x: 4300, y: 60 },
    sky: '#000000',
    tiles: [
      { x: 0,    y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 520,  y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 980,  y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 1500, y: 480, w: 200, h: 60,  type: 'ground' },
      { x: 2120, y: 480, w: 160, h: 60,  type: 'ground' },
      { x: 2500, y: 480, w: 200, h: 60,  type: 'ice' },
      { x: 2700, y: 480, w: 80,  h: 60,  type: 'bouncy' },
      { x: 2860, y: 80,  w: 40,  h: 460, type: 'wall' },
      { x: 3060, y: 80,  w: 40,  h: 460, type: 'wall' },
      { x: 2900, y: 80,  w: 160, h: 18,  type: 'branch' },
      { x: 3100, y: 140, w: 200, h: 18,  type: 'ground' },
      { x: 3800, y: 200, w: 100, h: 18,  type: 'branch' },
      { x: 4100, y: 100, w: 300, h: 18,  type: 'ground' },
    ],
    hazards: [
      { x: 200,  y: 530, w: 320,  h: 10, type: 'spikes' },
      { x: 680,  y: 530, w: 300,  h: 10, type: 'spikes' },
      { x: 1140, y: 530, w: 360,  h: 10, type: 'spikes' },
      { x: 1700, y: 530, w: 420,  h: 10, type: 'spikes' },
      { x: 2280, y: 530, w: 220,  h: 10, type: 'spikes' },
      { x: 2780, y: 530, w: 80,   h: 10, type: 'spikes' },
      { x: 2900, y: 530, w: 160,  h: 10, type: 'spikes' },
      { x: 3300, y: 530, w: 1100, h: 10, type: 'spikes' },
    ],
    platforms: [
      { x: 1780, y: 420, w: 80, h: 18, fall: true, delay: 0.25 },
      { x: 1880, y: 380, w: 80, h: 18, fall: true, delay: 0.25 },
      { x: 1980, y: 420, w: 80, h: 18, fall: true, delay: 0.25 },
      { x: 3400, y: 300, w: 100, h: 18, move: { axis: 'y', range: 100, speed: 60 } },
      { x: 3600, y: 260, w: 80,  h: 18, move: { axis: 'x', range: 80,  speed: 55 } },
    ],
    cannons: [
      { x: 100,  y: 400, w: 70, h: 70, angle: -22, power: 880 },
      { x: 580,  y: 400, w: 70, h: 70, angle: -25, power: 900 },
      { x: 1040, y: 400, w: 70, h: 70, angle: -20, power: 860 },
    ],
    ropes: [
      { x: 1600, y: 50, length: 200 },
      { x: 1820, y: 50, length: 180 },
      { x: 2040, y: 50, length: 200 },
      { x: 4000, y: 50, length: 200 },
    ],
    ziplines: [
      { x1: 3100, y1: 120, x2: 3400, y2: 280 },
      { x1: 3600, y1: 200, x2: 3800, y2: 180 },
    ],
    climbs: [
      { x: 2860, y: 80, w: 40, h: 200 },
    ],
    checkpoints: [
      { x: 1560, y: 420, w: 40, h: 60 },
      { x: 2180, y: 420, w: 40, h: 60 },
      { x: 3140, y: 80,  w: 40, h: 60 },
      { x: 3840, y: 160, w: 40, h: 60 },
    ],
    coins: [
      { x: 100, y: 420 },
      { x: 300, y: 260 }, { x: 400, y: 240 },
      { x: 600, y: 420 }, { x: 760, y: 260 }, { x: 860, y: 240 },
      { x: 1060, y: 420 },
      { x: 1300, y: 280 }, { x: 1400, y: 260 },
      { x: 1560, y: 420 },
      { x: 1640, y: 200 }, { x: 1860, y: 180 }, { x: 2080, y: 200 },
      { x: 2180, y: 420 },
      { x: 2560, y: 420 }, { x: 2640, y: 420 },
      { x: 2940, y: 360 }, { x: 2960, y: 240 }, { x: 2980, y: 120 },
      { x: 3160, y: 100 },
      { x: 3240, y: 200 }, { x: 3460, y: 260 },
      { x: 3660, y: 220 }, { x: 3840, y: 160 },
      { x: 4020, y: 100 },
      { x: 4160, y: 60 }, { x: 4260, y: 60 },
      { x: 4340, y: 60 },
      { x: 1820, y: 360 }, { x: 1920, y: 320 },
    ],
  },
];
